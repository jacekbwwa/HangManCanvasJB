...
## Live Link
https://jacekbwwa.github.io/HangManCanvasJB/
...
If there is  no trials (0 lives), the user looses.
The user wins when he guesses all letters.
The picture of gallows is drawn when the user miss the letter.
...
- The CSS sets up layout  of this project, giving the colors , rows, columns and margins, etc. Used css grid layout made it easier to design the web page.
